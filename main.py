...
Original file is located at
    https://colab.research.google.com/drive/1XzauAH-IAWGebu7bMrndktrCc2YciPex
"""
...
def getFaceData(video_url:str,train_url:str,search_class:str):
    """
    ...
    for data in data_list:
        if  search_class == '' or data['class_name'].lower() == search_class.lower():
...
@app.get("/")
def get_video(video_url: str = '',train_url:str = "https://attendityprivateapi.onrender.com/display/?class_name=BTECH",search_class: str = ''):
    data = getFaceData(video_url,train_url,search_class)
    json_str = json.dumps(data, indent=4, default=str)
    return Response(content=json_str, media_type='application/json')

# ngrok.set_auth_token("2TOUVegNoJulio8abk8cokAhkRR_7wVsyRPku8FR9uqAdnSZD")
